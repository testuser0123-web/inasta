...
test('migration, backfill, atomic flags, visibility and month queries', async () => {
  ...
  try {
    ...
    assert.deepEqual(data.days[1], { date: '2026-09-13', accessed: true, posted: true });
    ...
    assert.equal((await readActivityMonth(adapter, 1, undefined, '2026-09', now)).days.length, 2);
